...
// *****************************************Images upload code end here********************************************************** 
 		...
 		$query="Insert into student_info(first_name,last_name,father_name,email,course_code,profile_image,dob, gender,current_address)values('$first_name','$last_name','$father_name','$email','$course_code','$profile_image','$dob', '$gender','$current_address')";
		...
		<main role="main" class="col-xl-10 col-lg-9 col-md-8 ml-sm-auto px-md-4 w-100">
			<div class="sub-main">
				<div class="text-center d-flex flex-wrap flex-md-nowrap pt-3 pb-2 mb-3 text-white admin-dashboard pl-3">
					<div class="d-flex">
						<h4 class="mr-5">Student qo'shish bo'limi </h4>
					   ...
					   <div class="modal-dialog modal-lg">
						    <div class="modal-content">
							    <div class="modal-header bg-info text-white">
							        <h4 class="modal-title text-center">Yangi student qo'shish</h4>
						        </div>
					...
					<div class="col-md-12 ml-2">
						<section class="mt-3">
							...
							<table class="w-100 table-elements mb-5 table-three-tr text-center" cellpadding="10">
								...
								<?php 
								$query="select first_name,last_name,current_address,roll_no,profile_image from student_info";
								$run=mysqli_query($con,$query);
								while($row=mysqli_fetch_array($run)) {?>
									<tr>
