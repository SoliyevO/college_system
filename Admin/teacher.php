...
// *****************************************Images upload code end here********************************************************** 
 		...
 		$query="Insert into teacher_info(first_name,last_name,email,phone_no,profile_image,dob,gender,current_address,place_of_birth)values('$first_name','$last_name','$email','$phone_no','$profile_image','$dob','$gender','$current_address','$place_of_birth')";
					...
					<div class="col-md-12 ml-2">
						<section class="mt-3">
							...
							<table class="w-100 table-elements mb-5 table-three-tr" cellpadding="10">
								...
								<?php 
								$query="select teacher_id,first_name,last_name,current_address,hire_date,email from teacher_info";
								$run=mysqli_query($con,$query);
