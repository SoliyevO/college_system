...
<?php 
	...
	if (isset($_POST['sub'])) {
		...
		$query="update teacher_info set first_name='$first_name',last_name='$last_name',father_name='$father_name',gender='$gender',current_address='$current_address',permanent_address='$permanent_address',place_of_birth='$place_of_birth' where teacher_id='$teacher_id'";
